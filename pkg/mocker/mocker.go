...
func New(src, dst, pkg string, iface []string) (*mocker, error) {
	return &mocker{src, dst, pkg, iface}, nil
}
...
func (g *generator) Generate(pkg *model.Package, pkgName string, outputPkgPath string) error {
